...
if __name__ == '__main__':
    ...
    bboxes = [[74.90,250.16,104.35,286.82],
              [871.42,259.26,900.92,297.38],
              [451.48,264.31,482.92,305.67],
              [618.63,282.38,648.07,316.87],
              [348.44,264.21,375.59,299.17],
              [734.70,265.40,763.80,301.03],
              [495.54,267.46,523.81,300.98]
             ]
