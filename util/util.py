...
def landmarks106to68(lms):
    ...
    lms_68[40] = lms[56] * factor + lms[73] * (1 - factor)
    lms_68[41] = lms[57] * factor + lms[73] * (1 - factor)

    lms_68[43] = lms[59] * factor + lms[75] * (1 - factor)
    lms_68[44] = lms[60] * factor + lms[75] * (1 - factor)
    lms_68[46] = lms[62] * factor + lms[76] * (1 - factor)
