...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--use_gt_bbox', action='store_true', default=False)



        # basic parameters
        #parser.add_argument('--dataroot', default='placeholder', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='run1', help='name of the experiment. It decides where to store samples and models')
